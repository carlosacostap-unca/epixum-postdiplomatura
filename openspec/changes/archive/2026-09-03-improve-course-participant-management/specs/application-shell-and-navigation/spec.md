...
#### Scenario: Administración contextual de un curso
- **WHEN** un administrador abre un curso desde el área administrativa
- **THEN** dispone de navegación contextual entre Configuración, Participantes y Acceso
- **AND** la sección activa permanece identificada visual y semánticamente
