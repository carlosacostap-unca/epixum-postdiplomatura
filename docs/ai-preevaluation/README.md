...
- TP piloto activo: `Trabajo Práctico Semana 1` (`wk1moryv4oo4ggc`), configuración versión 1 con seis criterios ponderados, diez controles obligatorios, veredictos `Aprobado`, `Desaprobado` y `Corregir y reenviar`, y escala de 0 a 10 con umbral sugerido de aprobación de 6 puntos.
